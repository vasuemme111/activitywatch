...
#define MyAppName "SunDail"
#define MyAppVersion GetEnv('AW_VERSION')
#define MyAppPublisher "SunDail Contributors"
#define MyAppURL "https://SunDail.net/"
...
AppSupportURL="https://github.com/SunDail/SunDail/issues"
AppUpdatesURL="https://github.com/SunDail/SunDail/releases"
...
OutputDir={#DistDir}
OutputBaseFilename=SunDail-setup
...
Name: "StartMenuEntry" ; Description: "Start SunDail when Windows starts"; GroupDescription: "Windows Startup"; MinVersion: 4,4;
